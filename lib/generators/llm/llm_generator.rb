class LlmGenerator < Rails::Generators::Base
  ...
  def show_usage_instructions
    ...
    say "\n  2) Image generation (Turbo Streams):"
    say "     ImageGenerationJob.perform_later("
    say "       stream: \"images_\#{user.id}\","
    say "       prompt: 'A cat playing with a ball',"
    say "       images: ['https://example.com/style.png'] # optional"
    say "     )"
    ...
    say "  2) Subscribe Turbo Streams for image results (stream name used above)"
